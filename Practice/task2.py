...
# # while True:
# #     inp1 = int(input("You Have to create a today task (1/2): "))
# #     if(inp1 == 1):
# #         inp2 = input("Enter the name of the task : ")
# #         inp3 = input("Enter the task description : ")
# #         dict1.update({inp2:inp3})
# #     else:
# #         inp4 = input("Enter the task name to delete the task : ")
# #         dict1.pop(inp4)
# #         break
...
data = '''
#1: It's only when you have the courage to step oﬀ the ledge that you'll realize you've had wings all along.
...
#4: e greatest personal fulfillment comes when we contribute to improving the welfare of others.
...
3365 DAILY QUOTES FOR INSPIRED LIVING
...
#19: Praise is one of the best, yet inexpensive gis we can give to others.
#20: ere is nothing more important in the world than loving yourself.
#21: In times of turmoil, it matters not that we forgot we are infinite, unlimited beings. What matters
...
thoughts.
#24: Remember, perspective can cause two people to look at the same thing and see two totally diﬀerent
things.
...
4365 DAILY QUOTES FOR INSPIRED LIVING
...
#33: e fastest way to get unstuck is to go do something for someone else.
#34: Success oen comes to those who are too naïve to know that what they're trying to do is impossible.
...
#38: Either way you're going oﬀ the ledge. So why not jump now so God doesn't have to push you? Your
wings are beautiful!
...
#41: e greatest limitations in life are the ones we place on ourselves.
...
5365 DAILY QUOTES FOR INSPIRED LIVING
...
of it.
#52: e fastest way to get to the life you want is to just play make believe that you already have it today.
#53: Integrity is holding fast to our convictions regardless of the consequences and never compromising
our ideals or values, even if it aﬀects the bottom line.
...
excellence!
6365 DAILY QUOTES FOR INSPIRED LIVING
...
#68: e more clear you are in the vision of what you want in life, the brighter the spotlight will be to
...
#73: Don't let your fear of the hazards keep your ship in the harbor. Cast oﬀ your lines and sail away!
7365 DAILY QUOTES FOR INSPIRED LIVING
#74: If you can’t change the circumstances, change your attitude. Funny thing is, when you do, you’ll find
that the circumstances oen change.
...
#81: e shortest path to success--focus on the 'what' and the 'why', not the 'how'. Works every time.
...
better start living.
8365 DAILY QUOTES FOR INSPIRED LIVING
#88: “Can't” isn't a word. You have the power to do, be or create anything.
#89: If you wait for everything to be perfect before taking action on your dream, you'll never take the first
step.
...
#92: If we allow our definition of what's possible to be based on how big someone else can dream, our
dream will die.
...
#102: Adversity could be the greatest gi in our life, in retrospect.
9365 DAILY QUOTES FOR INSPIRED LIVING
...
#108: What's happening on the outside doesn't have the power the aﬀect what's happening on the inside,
unless we allow it to.
#109: When Universal timing and our timing are diﬀerent, that doesn't mean that things aren't working.
Trust the process.
...
10365 DAILY QUOTES FOR INSPIRED LIVING
...
will be YES!?
#122: e two most powerful words in any language--“ank you!”
...
11365 DAILY QUOTES FOR INSPIRED LIVING
...
#135: Live well, laugh oen, love deeply.
...
#140: Even the largest of fires starts from a tiny spark. at same potential is within you, so set your
dreams on fire!
...
12365 DAILY QUOTES FOR INSPIRED LIVING
#147: Pain may be inevitable but remember, suﬀering is optional.
...
#158: Someone in the world is better oﬀ today because of something you've done.
...
13365 DAILY QUOTES FOR INSPIRED LIVING
...
#163: We make the greatest diﬀerence in the world when we find a cause that's bigger than our fears and
...
#170: Adversity is the Universe's way of directing us down a diﬀerent path.
...
#173: If you've hit a wall or the door has closed, keep looking until you find the window, for there's
always a solution.
...
14365 DAILY QUOTES FOR INSPIRED LIVING
...
#184: More forward with confidence, knowing in the core of your being that you have the power to
achieve your dreams.
...
15365 DAILY QUOTES FOR INSPIRED LIVING
...
#196: Don't put oﬀ until tomorrow that which you can enjoy today!
#197: Challenge is nothing more than a seed of opportunity.
#198: Play BIG, make it fun or don't play at all. Might as well make it worth the eﬀort, no?
...
16365 DAILY QUOTES FOR INSPIRED LIVING
...
caterpillar.
#210: Even enlightened people have problems. e only diﬀerence is in their reaction to them.
...
change our world.
17365 DAILY QUOTES FOR INSPIRED LIVING
...
attention.
#223: Even if you don't know how to complete a project, just take the first step. ere is power in action.
...
18365 DAILY QUOTES FOR INSPIRED LIVING
#235: e only way to bring something into your life is to first believe that it's possible, for without vision
...
#238: Go with the flow and be willing to allow change into your life, for change is the only thing that's
constant.
...
19365 DAILY QUOTES FOR INSPIRED LIVING
...
didn't.
#251: Limitations are nothing more than artificial boundaries that we create to feel safe. Remember, you
can do anything!
...
#255: It is your attitude that will determine your altitude in life. Confidence and optimism will take you
to the top of the mountain.
#256: We have a finite amount of time, so the more we worry, the less time we have to dream. For me, I
think I'd rather dream.
#257: e most important person to love, is YOU. Once you do that, it's easier to love everyone else.
...
of ourselves.
#260: Nothing eliminates pain and diﬃculty in our life faster than a greater purpose.
#261: Dream incessantly, Believe completely, Act daily, Risk intuitively, Celebrate continually.
20365 DAILY QUOTES FOR INSPIRED LIVING
...
something shis within that allows the solution to reveal itself.
#271: Everyday, if we find someone who's having a bad day and send them some love, we just might
change the world.
...
#275: When you feel sad or stuck, remember your life can change in the flash of a moment, and perhaps
that moment is now.
21365 DAILY QUOTES FOR INSPIRED LIVING
...
#281: e only thing that makes a good day diﬀerent from a bad day, Is simply our perception.
...
22365 DAILY QUOTES FOR INSPIRED LIVING
...
23365 DAILY QUOTES FOR INSPIRED LIVING
...
#320: Circumstances can’t aﬀect whether or not you are happy, when your happiness is not dependent
upon a reason.
24365 DAILY QUOTES FOR INSPIRED LIVING
#321: Collaboration is the new black. Competition only exists in our minds. ere's plenty for all of us.
...
#324: When you can be happy right now, in spite of problems, you'll find they disappear much more
quickly.
...
release, catch.
#331: ink without boundaries. Dream without limitations.
...
25365 DAILY QUOTES FOR INSPIRED LIVING
...
#338: e nutritional choices we make today will directly aﬀect the health of our bodies tomorrow.
Choose wisely.
#339: You'll always find what you're looking for, either the good or the bad, in any situation... but finding
...
#350: Carrying yesterday's problems with you today is like trying to fly while carrying a sack of rocks.
26365 DAILY QUOTES FOR INSPIRED LIVING
...
new = data.split(":")  #to split all lines with :
new = new[1:]  # To remove first element.
for i in range(len(new)):
    index = new[i].find("#") # To find ending of the line
    new[i]=new[i][1:index]   # To end the line.
    new[i]=new[i].replace("\n", " ") # To convert multiline text into single line 

for i in range(5):
    print(new[i]) # To print Demo.